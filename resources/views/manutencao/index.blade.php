        ...
        <div class="col-xl-12 col-xxl-12 d-flex">
            <div class="w-100">
                <div class="row">
                   ...
                   <p style="color: red"><strong>Data</strong>: {{$log->created_at ?? ''}}</p>
                   <p style="color: red"><strong>Horas</strong>: {{$log->created_at ?? ''}}</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h1 class="mt-1 mb-3"> 
                                        @if (count(\App\Models\Equipment::all()) == 0)
                                            0%
                                        @else
                                            {{round(count(\App\Models\Equipment::where('status',1)->get())*100/count(\App\Models\Equipment::all()),2)  }} % 
                                        @endif
